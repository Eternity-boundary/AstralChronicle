...
namespace winrt::AstralChronicle::implementation
{
    ...
    void RemotePage::Initialize(std::shared_ptr<::AstralChronicle::services::IRemoteEventService> service, std::shared_ptr<::AstralChronicle::services::IEventQueryService> localQuery, std::shared_ptr<::AstralChronicle::design::IStringResourceService> strings) { winrt::get_self<RemoteViewModel>(m_viewModel)->Initialize(std::move(service), std::move(localQuery), std::move(strings), PageRoot().DispatcherQueue()); }
    void RemotePage::OnConnectClicked(winrt::Windows::Foundation::IInspectable const&, Microsoft::UI::Xaml::RoutedEventArgs const&) { winrt::get_self<RemoteViewModel>(m_viewModel)->Connect(); RemotePasswordBox().Password({}); }
    ...
    void RemotePage::OnTestConnectionClicked(winrt::Windows::Foundation::IInspectable const&, Microsoft::UI::Xaml::RoutedEventArgs const&) { winrt::get_self<RemoteViewModel>(m_viewModel)->TestConnection(); RemotePasswordBox().Password({}); }
    ...
    void RemotePage::OnQueryChannelChanged(winrt::Windows::Foundation::IInspectable const& sender, Microsoft::UI::Xaml::Controls::SelectionChangedEventArgs const&) { auto const combo = sender.as<Microsoft::UI::Xaml::Controls::ComboBox>(); if (!combo.SelectedValue()) return; try { winrt::get_self<RemoteViewModel>(m_viewModel)->QueryChannel(winrt::unbox_value<winrt::hstring>(combo.SelectedValue())); } catch (...) { } }
    ...
    void RemotePage::OnUnloaded(winrt::Windows::Foundation::IInspectable const&, Microsoft::UI::Xaml::RoutedEventArgs const&) { winrt::get_self<RemoteViewModel>(m_viewModel)->Shutdown(); }
}
