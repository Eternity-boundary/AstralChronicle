...
namespace winrt::AstralChronicle::implementation
{
    ...
    {
        SessionsViewModel();
        void Initialize(std::shared_ptr<::AstralChronicle::services::ISessionRepository> repo, std::shared_ptr<::AstralChronicle::design::IStringResourceService> strings, Microsoft::UI::Dispatching::DispatcherQueue const& dispatcher);
