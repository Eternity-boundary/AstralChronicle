...
namespace winrt::AstralChronicle::implementation
{
    struct SessionsViewModel : SessionsViewModelT<SessionsViewModel>
    {
        ...
        [[nodiscard]] Windows::Foundation::Collections::IVectorView<winrt::hstring> Sessions() const; [[nodiscard]] Microsoft::UI::Xaml::Controls::InfoBarSeverity StatusSeverity() const noexcept; [[nodiscard]] bool HasStatusMessage() const noexcept; [[nodiscard]] bool IsLoading() const noexcept;
    ...
    private:
        ...
        ::AstralChronicle::services::ISessionRepository* m_repo{}; ::AstralChronicle::design::IStringResourceService const* m_strings{}; Microsoft::UI::Dispatching::DispatcherQueue m_dispatcher{nullptr}; std::uint64_t m_version{}; std::vector<::AstralChronicle::models::DiagnosticSession> m_models; winrt::Windows::Foundation::Collections::IVectorView<winrt::hstring> m_sessions{nullptr}; std::int32_t m_selectedIndex{-1};
