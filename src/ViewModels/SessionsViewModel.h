...
namespace winrt::AstralChronicle::implementation
{
    ...
    private:
        ...
        ::AstralChronicle::services::ISessionRepository* m_repo{}; ::AstralChronicle::design::IStringResourceService const* m_strings{}; Microsoft::UI::Dispatching::DispatcherQueue m_dispatcher{nullptr}; std::uint64_t m_version{}; std::vector<::AstralChronicle::models::DiagnosticSession> m_models; winrt::Windows::Foundation::Collections::IObservableVector<winrt::hstring> m_sessions{nullptr}; std::int32_t m_selectedIndex{-1};
